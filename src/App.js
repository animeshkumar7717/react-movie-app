    ...
    <div className='container-fluid movie-app'>
      <div className='bottom-section'>
        <div className='left-section col-3' >
          <div className='search-container' style={{ display: 'flex', flexDirection: 'column', padding: '20px', borderBottom: '1px solid #ccc' }}>
            ...
            <div className='home-button' style={{ margin: '20px', width: '100%', background: 'crimson', borderRadius: '5px', padding: '5px' }}>
              <Button name='Home' onClick={onclickHandler} />
            </div>
            <h3 style={{ textAlign: 'center', marginBottom: '10px' }}>My Lists</h3>
          </div>
